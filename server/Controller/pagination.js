class Pagination {
    ...
    links() {
        ...
        if (this.previousPage > 0)
            this.pages += '<li class="page-item"><a class="page-link"  onclick="getresult('+ this.previousPage +')" >Previous</a></li>';
        ...
        if (this.currentPage > 1) {
            for (var x = this.currentPage - this.sidePages; x < this.currentPage; x++) {
                if (x > 0)
                    this.pages += '<li class="page-item"><a class="page-link" onclick="getresult('+x+')" >' + x + '</a></li>';
            }
        }

        // Show current page
        this.pages += '<li class="page-item active"><a class="page-link"  onclick="getresult('+this.currentPage+')" >' + this.currentPage + '</a></li>';
        ...
        if (this.currentPage + 1 <= this.pageCount)
            this.pages += '<li class="page-item"><a class="page-link"  onclick="getresult('+this.nextPage+')">Next</a></li>';
